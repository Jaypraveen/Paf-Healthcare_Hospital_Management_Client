...
public class HospitalAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = h1.insertHospital(request.getParameter("hosName"),
				request.getParameter("hosTelNo"),
				request.getParameter("hosAddress"),
				request.getParameter("hosEmail"));
		
		System.out.println(request.getParameter("hosName")+" "+request.getParameter("hosTelNo")+" "+request.getParameter("hosAddress")+" "+request.getParameter("hosEmail"));
