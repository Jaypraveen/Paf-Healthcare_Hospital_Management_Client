...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" id="formHospital" name="formHospital" method="post" action="Hospital_Insert.jsp">
				<span class="contact100-form-title">
					Hospital Registation
				</span>

			<label class="label-input100" for="email">Hospital Name</label>
				<div class="wrap-input100 validate-input">
					<input  class="input100"id="hosName" name="hosName" type="text" required>
				...
				<div class="wrap-input100">
					<input  class="input100"id="hosAddress" name="hosAddress" type="text"
				...
				<div id="alertSuccess" class="alert alert-success" style="margin-left: 144px;"></div>
	<div id="alertError" class="alert alert-danger" style="margin-left: 144px;"></div>
			</form>
